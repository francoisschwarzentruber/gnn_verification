...
(declare-const fp0 Float32)
(assert (= fp0 (fp #b0 #b00000000 #b00000000000000000000000)))
(declare-const fp1 Float32)
(assert (= fp1 (fp #b0 #b01111111 #b00000000000000000000000)))
...
(assert (= (fp.add RNE x0_0 (fp.add RNE x0_1 x0_2)) fp1))
...
(assert (= (fp.add RNE x1_0 (fp.add RNE x1_1 x1_2)) fp1))

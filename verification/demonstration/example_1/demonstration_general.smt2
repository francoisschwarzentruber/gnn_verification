...
;; precondition f0[0] == 0 || precondition f0[0] == 1
(assert (or (= f0_0 (fp #b0 #b00000000 #b00000000000000000000000)) (= f0_0 (fp #b0 #b01111111 #b00000000000000000000000))))

(assert (or (= f0_1 (fp #b0 #b00000000 #b00000000000000000000000)) (= f0_1 (fp #b0 #b01111111 #b00000000000000000000000))))
...
(assert (or (= f1_0 (fp #b0 #b00000000 #b00000000000000000000000)) (= f1_0 (fp #b0 #b01111111 #b00000000000000000000000))))

(assert (or (= f1_1 (fp #b0 #b00000000 #b00000000000000000000000)) (= f1_1 (fp #b0 #b01111111 #b00000000000000000000000))))

;; declare feature f2
(declare-const f2_0 Float32)
(declare-const f2_1 Float32)

(assert (or (= f2_0 (fp #b0 #b00000000 #b00000000000000000000000)) (= f2_0 (fp #b0 #b01111111 #b00000000000000000000000))))

(assert (or (= f2_1(fp #b0 #b00000000 #b00000000000000000000000)) (= f2_1 (fp #b0 #b01111111 #b00000000000000000000000))))

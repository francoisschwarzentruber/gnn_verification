...
;; precondition x0[0] == 0 || precondition x0[0] == 1
(assert (or (= x0_0 (fp #b0 #b00000000 #b00000000000000000000000)) (= x0_0 (fp #b0 #b01111111 #b00000000000000000000000))))
;; precondition x0[1] == 0 || precondition x0[1] == 1
(assert (or (= x0_1 (fp #b0 #b00000000 #b00000000000000000000000)) (= x0_1 (fp #b0 #b01111111 #b00000000000000000000000))))
;; precondition x0[2] == 0 || precondition x0[2] == 1 
(assert (or (= x0_2 (fp #b0 #b00000000 #b00000000000000000000000)) (= x0_2 (fp #b0 #b01111111 #b00000000000000000000000))))
...
;; precondition x1[0] == 0 || precondition x1[0] == 1
(assert (or (= x1_0 (fp #b0 #b00000000 #b00000000000000000000000)) (= x1_0 (fp #b0 #b01111111 #b00000000000000000000000))))
;; precondition x1[1] == 0 || precondition x1[1] == 1
(assert (or (= x1_1 (fp #b0 #b00000000 #b00000000000000000000000)) (= x1_1 (fp #b0 #b01111111 #b00000000000000000000000))))
;; precondition x1[2] == 0 || precondition x1[2] == 1
(assert (or (= x1_2 (fp #b0 #b00000000 #b00000000000000000000000)) (= x1_2 (fp #b0 #b01111111 #b00000000000000000000000))))
...
(assert
   (= x10_0
      (fp.add RNE x8_0 (fp #b0 #b01111101 #b01000111101000010010100))
   )
)
(assert
   (= x10_1
      (fp.add RNE x8_1 (fp #b1 #b01111100 #b01100101010101110011110))
   )
)
(assert
   (= x10_2
      (fp.add RNE x8_2 (fp #b0 #b01111100 #b11111100100000001001110))
   )
)
...
(assert
  (= x12_0
     (fp.add RNE
       (fp.add RNE
         (fp.mul RNE x4_0 (fp #b1 #b01111110 #b11101111010000111100110))
         (fp.mul RNE x4_1 (fp #b1 #b01111100 #b00101110010001111010010))
       )
       (fp.mul RNE x4_2 (fp #b1 #b01111011 #b11100000111100001000111))
     )
  )
)
(assert
  (= x12_1
     (fp.add RNE
       (fp.add RNE
         (fp.mul RNE x4_0 (fp #b0 #b01111001 #b01011110011010000000000))
         (fp.mul RNE x4_1 (fp #b0 #b01111100 #b11010011011100110001100))
       )
       (fp.mul RNE x4_2 (fp #b0 #b01111101 #b01100010101111001100110))
     )
  )
)
(assert
  (= x12_2
     (fp.add RNE
       (fp.add RNE
         (fp.mul RNE x4_0 (fp #b0 #b01111101 #b10011001011001101101110))
         (fp.mul RNE x4_1 (fp #b1 #b01111101 #b01111110101001110101001))
       )
       (fp.mul RNE x4_2 (fp #b1 #b01111100 #b11111011101001100101100))
     )
  )
)
...
(assert
  (= x16_0
     (fp.add RNE
       (fp.add RNE
         (fp.mul RNE x6_0 (fp #b0 #b01111011 #b00101111100101101000101))
         (fp.mul RNE x6_1 (fp #b0 #b01111010 #b11110010110011111110011))
       )
       (fp.mul RNE x6_2 (fp #b0 #b01111010 #b11110100100001010110011))
     )
  )
)
(assert
  (= x16_1
     (fp.add RNE
       (fp.add RNE
         (fp.mul RNE x6_0 (fp #b1 #b01111110 #b00010010001110001111001))
         (fp.mul RNE x6_1 (fp #b1 #b01111101 #b01110100001011111110000))
       )
       (fp.mul RNE x6_2 (fp #b1 #b01111100 #b00101011010110001001000))
     )
  )
)
(assert
  (= x16_2
     (fp.add RNE
       (fp.add RNE
         (fp.mul RNE x6_0 (fp #b0 #b01111100 #b00011000000001001110110))
         (fp.mul RNE x6_1 (fp #b1 #b01111001 #b01100001010001001001110))
       )
       (fp.mul RNE x6_2 (fp #b1 #b01111010 #b10110010100001100001110))
     )
  )
)
...
(assert
   (= x18_0
      (fp.add RNE x16_0 (fp #b1 #b01111011 #b10010011110110010100111))
   )
)
(assert
   (= x18_1
      (fp.add RNE x16_1 (fp #b1 #b01111101 #b10011101000010100111100))
   )
)
(assert
   (= x18_2
      (fp.add RNE x16_2 (fp #b1 #b01111100 #b01101110011110100111000))
   )
)
...
(assert (= x22_0 (relu x20_0)))
(assert (= x22_1 (relu x20_1)))
(assert (= x22_2 (relu x20_2)))
...
(assert
  (= x24_0
     (fp.add RNE
       (fp.mul RNE x22_0 (fp #b0 #b10000001 #b00110101100100100000100))
       (fp #b1 #b10000000 #b00011010001100110011010)
     )
  )
)
(assert
  (= x24_1
     (fp.add RNE
       (fp.mul RNE x22_1 (fp #b0 #b10000111 #b00111100001110100101000))
       (fp #b0 #b01111100 #b10100011100001011111011)
     )
  )
)
(assert
  (= x24_2
     (fp.add RNE
       (fp.mul RNE x22_2 (fp #b0 #b10000000 #b01011001011100101000001))
       (fp #b1 #b10000000 #b00111110011101011111001)
     )
  )
)
...
(assert
  (= x26_0
     (fp.add RNE
       (fp.add RNE
         (fp.mul RNE x24_0 (fp #b1 #b01111111 #b00101011000001001101110))
         (fp.mul RNE x24_1 (fp #b0 #b01111110 #b01110011101011101011011))
       )
       (fp.mul RNE x24_2 (fp #b0 #b01111110 #b11110000101100011111000))
     )
  )
)
...
(assert
  (= x26_1
     (fp.add RNE
       (fp.add RNE
         (fp.mul RNE x24_0 (fp #b0 #b01111111 #b00011100110111000001001))
         (fp.mul RNE x24_1 (fp #b0 #b01110111 #b11000011000100111010101))
       )
       (fp.mul RNE x24_2 (fp #b1 #b01111111 #b00000010100110110101000))
     )
  )
)
...
(assert
   (= x28_0
      (fp.add RNE x26_0 (fp #b0 #b01111101 #b01001111000000101000000))
   )
)

(assert
   (= x28_1
      (fp.add RNE x26_1 (fp #b1 #b01111101 #b11001100001100011111000))
   )
)
...
(declare-const x30_0 Int)
(assert (= x30_0 (argmax x28_0 x28_1)))

;; forbid class 1 for node 0
(assert (not (= x29_0 1)))

(check-sat)
(get-value (x29_0 x30_0))
...
path_dir=f'{file_path}/demonstration/example_1_asmodel/{folder}'
...
agg_global = np.dot(np.ones((x.shape[0], x.shape[0]), dtype=np.float32), x)
...
binary_classification = np.array(binary_classification)
